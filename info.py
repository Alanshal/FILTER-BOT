...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002529983041 -1002432923495').split()]  # For Multiple Id Use One Space Between Each.
